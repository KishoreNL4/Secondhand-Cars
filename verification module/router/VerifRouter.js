  ...
  try {
    ...
    DataRequest.push(
      req.db
        ...
        .findOne({ MobileNo: MobileNo }, { projection: { _id: 1, pwdhash: 1 } })
    );
      ...
      .then(async function (results) {
        if (results[0]) {
          if (bcrypt.compareSync(Password, results[0].pwdhash)) {
            ...
            const verifAgent = await req.db
              .collection("TbVerifAgent")
              .findOne({ _id: results[0]._id }, { projection: { Name: 1 } });
            ...
            var data = {
              MobileNo: MobileNo,
              MessageType: "M01",
              MessageNo: "LOGPWD-INV",
              MessageDes: "Invalid Mobile No. or Password. Please try again.",
            };
...
VerifRouter.post("/verif-verifform", async function (req, res) {
  try {
    ...
    var Owner = req.body.txtOwnername;
    var Mobile = req.body.txtMobile;
    var Brand = req.body.txtBrand;
    var Model = req.body.txtModel;
    var RgNumber = req.body.txtregistration;
    var RgValidity = req.body.txtRegistrationvalidity;
    var Colour = req.body.txtColour;
    var Chase = req.body.txtChassis;
    var Engine = req.body.txtEngine;
    var Accident = req.body.txtAccident;
